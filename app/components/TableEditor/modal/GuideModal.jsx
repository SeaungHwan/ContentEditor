    ...
    <div className={layout.modalPopWrap2} style={fadeStyle}>
        <div className={layout.modalPop2}>
            <div className={layout.titWrap2}>
                <h4 className={`tit-st contents ${layout.modalTitH4}`}>주의점</h4>
               
            </div>
            <div className={layout.modalCont}>
                <ul className="bu-st2 list">
                ...
                <h4 className={`tit-st item ${layout.modalTitMt}`}>리스트 &lt;ul&gt; 및 &lt;ol&gt; 적용 기준</h4>
                <ul className="bu-st2 list">
                 ...
                 <div className='ar'><button type="button" onClick={onClose} className="btn-st gray">닫기</button></div>
            </div>
